...
GEM5_DIR=/home/lixinghao/Gem5
#<PATH_TO_YOUR_GEM5_INSTALL>                          # Install location of gem5
SPEC_DIR=/home/lixinghao/cpu2006-v1.1
...
SCRIPT_OUT=$OUTPUT_DIR/runscript_$BENCHMARK.log                                                                    # File log for this script's stdout henceforth
...
--nvmain-config=../RTsim/Config/RM.config \
--mem-size=4096MB \
-I 200000000 \
| tee -a $SCRIPT_OUT
